      ...
      "social": [
        {
          ...
          "stats": [
            {
              "label": "Подписчики",
              "value": "+31 за неделю — таргетированная реклама"
            },
            {
              "label": "Охват",
              "value": "—"
    ...
    },
    {
      ...
      "alerts": [
        ...
        },
        {
          ...
          "text": "ВК 15, Юла 11, простоев на неделе не было. Расход: ВК 23 102 ₽, Юла 2 799 ₽ — лид из ВК стоил 1 540 ₽ против 109 ₽ на Авито. Пик пришёлся на 10 и 11 августа (11 и 7 откликов), 15 и 16 августа — пусто. Таргетированная реклама дополнительно привела 27 подписчиков в сообщество. Реклама в Telegram по-прежнему на паузе — продолжается найм SMM-специалиста."
        }
      ],
      "projects": [
        {
      ...
      "social": [
        {
          ...
          "stats": [
            {
              "label": "Подписчики",
              "value": "+27 за неделю — таргетированная реклама"
            },
            {
              "label": "Охват",
              "value": "—"
    ...
    },
    {
      ...
      "extraKpi": {
        ...
        "notes": [
          ...
          "↓ Конверсия ЧЛБ+КЗН 57,1% → 47,1%, вышедших 234 → 222",
      ...
      "alerts": [
        ...
        {
          "type": "critical",
          "title": "Стоимость вышедшего: 11 477 ₽ у ОПИ против 504 ₽ у ДРС",
          "text": "У Даниила 27 вышедших на 3 293 лида (0,8%) при расходе 309 879 ₽. У Дианы 244 вышедших на 914 лидов (26,7%) при 123 010 ₽. CPL у обоих сопоставим, а стоимость результата отличается в 23 раза. Пока не подтверждено, полностью ли заполняется колонка «Вышедшие» по ОПИ — это первое, что нужно проверить."
        },
        {
          "type": "warning",
          "title": "ВК Дианы: 5 354 ₽ и ноль лидов — вторая неделя подряд",
          "text": "За две недели 10 540 ₽ без единого зафиксированного отклика. Либо лиды не попадают в листы «Оперблок» и «Ростикс», либо открутка идёт вхолостую. Проверить учёт до конца недели."
        }
      ],
      "projects": [
      ...
      "chlbkzn": { "leads": 471, "cpl": 123, "spend": 58104, "adapted": 222, "conversion": 47.13 },
      ...
      "social": [
        {
          ...
          "stats": [
            ...
            { "label": "Динамика лидов", "value": "26 → 18 (−31%)" },
            { "label": "Расход", "value": "ВК 20 544 ₽ · Юла 4 775 ₽" },
            { "label": "Цена лида ВК", "value": "1 712 ₽ ↑ против 109 ₽ на Авито" }
          ]
        },
        {
          "name": "✈ Telegram",
