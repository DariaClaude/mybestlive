...
const WAR_ROOM_DATA = {
  "weeks": [
    ...
    },
    {
      ...
      "vk": 19,
      "yula": 8,
      "vkyulaNote": "ВК за 24.08–01.09 · Юла — чистая неделя 24–30.08",
      "extraKpi": {
        "label": "Проекты ДРС",
        "value": "842",
      ...
      "social": [
        {
          ...
          "platform": "таргет / сообщество",
          "stats": [
            { "label": "Подписчики", "value": "1 316 → 1 324 (+8)" },
            { "label": "Лиды ВК / Юла", "value": "27 (ВК 19 + Юла 8)" },
            { "label": "Динамика лидов", "value": "18 → 27 (+9, +50%)" },
            { "label": "Расход", "value": "ВК 23 562 ₽ · Юла 4 264 ₽" },
            { "label": "Цена лида", "value": "ВК 1 240 ₽ · Юла 533 ₽" },
            { "label": "Период ВК", "value": "24.08–01.09 — выгрузка из кабинета" }
          ]
        },
        {
          "name": "✈ Telegram",
