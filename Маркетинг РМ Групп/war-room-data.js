...
const WAR_ROOM_DATA = {
  "weeks": [
      ...
      "alerts": [
        {
          ...
          "text": "Лиды выросли втрое (673 → 2 158), расход — в 2,4 раза (88 054 → 209 861 ₽). Проект забрал 68% недельного бюджета ОПИ и дал 66% лидов. Вышедших при этом 29 — конверсия 1,34%. Стоимость одного вышедшего по проекту — 7 236 ₽. Требуется решение: нужен ли такой объём при текущей потребности."
        },
        {
          "type": "success",
        ...
        {
          "type": "critical",
          "title": "Стоимость вышедшего: 5 534 ₽ у ОПИ против 488 ₽ у ДРС",
          "text": "У Даниила 56 вышедших на 3 293 лида Авито (1,7%) при расходе 309 879 ₽. У Дианы 252 вышедших на 914 лидов Авито (27,6%) при 123 010 ₽. CPL у обоих сопоставим, а стоимость результата отличается почти в 11 раз. Колонку «Вышедшие» по ОПИ дозаполняли дважды: сначала 27, потом 58, сейчас 56."
        },
        {
          "type": "warning",
    ...
    },
    {
      ...
      "vk": 26,
      "yula": 14,
      "vkyulaNote": "ВК и Юла за 24.08–01.09",
      "extraKpi": {
        "label": "Проекты ДРС",
        "value": "842",
      ...
      "alerts": [
        ...
        {
          "type": "success",
          "title": "ДРС: 266 вышедших при 842 лидах — конверсия 31,6%",
          "text": "Против 27,6% неделей раньше. Лучшие: ЧЛБ Монетка 118 вышедших из 193 (61,1%), Лента ЧЛБ 30 из 52 (57,7%), Лента КЗН 12 из 21 (57,1%). Стоимость вышедшего по ДРС — 501 ₽. Колонку дозаполнили: Лента КЗН 12 и Пятёрочка КЗН 3. Ростикс при 104 лидах дал 0 выходов — единственный проект ДРС без результата."
        },
        {
          "type": "warning",
          "title": "Вышедшие по ОПИ: 16 на 3 012 лидов (0,53%)",
          "text": "Неделей раньше было 56 на 3 293 (1,70%). Стоимость вышедшего выросла с 5 534 до 23 958 ₽. По Курьерам за неделю ячейка пустая при 219 лидах, поэтому цифра 16 может быть неполной — как это уже было с неделей 17–23."
        }
      ],
      "projects": [
      ...
      "chlbkzn": { "leads": 457, "cpl": 115, "spend": 52726, "adapted": 239, "conversion": 52.30 },
      "msk":     { "leads": 82,  "cpl": 98,  "spend": 8065,  "adapted": 4,   "conversion": 4.88 },
      "rostiks": { "leads": 104, "cpl": 116, "spend": 12038, "adapted": 0,   "conversion": 0 },
      "social": [
        {
          "name": "💙 ВКонтакте",
          "platform": "таргет / сообщество",
          "stats": [
            { "label": "Подписчики", "value": "1 316 → 1 344 (+28)" },
            { "label": "Лиды ВК / Юла", "value": "40 (ВК 26 + Юла 14)" },
            { "label": "Динамика лидов", "value": "18 → 40 (+22, +122%)" },
            { "label": "Расход", "value": "ВК 23 562 ₽ · Юла 6 344 ₽" },
            { "label": "Цена лида", "value": "ВК 906 ₽ · Юла 453 ₽" }
          ]
        },
        {
          "name": "✈ Telegram",
    ...
    },
    {
      ...
      "vk": 62,
      "yula": 15,
      "vkyulaNote": "ВК и Юла за 31.08–08.09",
      "extraKpi": {
        "label": "Проекты ДРС",
        "value": "1 031",
        "sub": "Урбан 273 · ЧЛБ+КЗН 441 · ВкусВилл 180 · Ростикс 137",
        "notes": [
          "↓ CPL Урбан 303 → 182 ₽ (−121 ₽) при росте 199 → 273 лида",
          "↓ CPL ЧЛБ+КЗН 115 → 111 ₽, лиды 457 → 441",
          "↑ ВкусВилл 82 → 180 лидов, CPL 98 → 132 ₽",
          "↑ Ростикс 104 → 137 лидов, CPL 116 → 177 ₽",
          "Вышедшие заполнены по 9 проектам из 10: 237"
        ]
      },
      "alerts": [
        {
          "type": "success",
          "title": "CPL Авито 127 → 91 ₽ (−28%) при росте лидов на 16%",
          "text": "Расход ОПИ снижен с 383 331 до 317 617 ₽ (−17%), лиды выросли с 3 012 до 3 499. Неделей раньше бюджет и объём расходились в разные стороны — сейчас движение синхронное и в нужную сторону. Дешевле всех МАГНИТ КРД (70 ₽), дороже всех Гравис (99 ₽)."
        },
        {
          "type": "success",
          "title": "Курьеры: расход сокращён на 29%, лидов вдвое больше",
          "text": "86 729 → 61 757 ₽ при лидах 219 → 440. По расходу лид стоит 140 ₽ против 396 ₽ неделей раньше. Прошлая аномалия с продвижением закрыта: план выполнен на 147% вместо 73%."
        },
        {
          "type": "success",
          "title": "Урбан Дикси: CPL 303 → 182 ₽ при росте объёма на 37%",
          "text": "199 → 273 лида, расход 60 343 → 49 757 ₽ (−18%). Проект вернулся к уровню середины августа. Прошлую неделю он был самой дорогой позицией ДРС — сейчас дороже него Ростикс (177 ₽)."
        },
        {
          "type": "success",
          "title": "Инвентаризация: CPL 90 → 76 ₽, расход −21%",
          "text": "1 617 лидов при 141 137 ₽ против 1 500 при 178 039 ₽. План перевыполнен в 2,3 раза. Доля в бюджете ОПИ 46% → 44% — проект перестал доминировать в расходе и при этом подешевел."
        },
        {
          "type": "warning",
          "title": "ДРС: 237 вышедших, средняя конверсия по проектам 24,7%",
          "text": "Лучшие: ЧЛБ Монетка 150 из 181 (82,9%), Лента ЧЛБ 22 из 46 (47,8%), ЧЛБ Пятёрочка 5 из 17 (29,4%). Урбан Дикси 25 из 273 — 9,2%. Колонку дозаполнили: Лента КЗН 1, Пятёрочка КЗН 1, Ростикс 0 при 137 лидах — средняя снизилась с 35,4% до 24,7%. По ВкусВиллу выходов пока нет."
        }
      ],
      "projects": [
        { "name": "МАГНИТ КРД", "plan": 150, "fact": 196, "cpl": 70, "hidden": false },
        { "name": "ЛЕНТА КРД", "plan": 450, "fact": 459, "cpl": 74, "hidden": false },
        { "name": "ЛЕНТА КЗН", "plan": 80, "fact": 106, "cpl": 78, "hidden": false },
        { "name": "ЛЕНТА МСК", "plan": 500, "fact": 587, "cpl": 73, "hidden": false },
        { "name": "ЛЕНТА ЧЛБ", "plan": 30, "fact": 33, "cpl": 86, "hidden": false },
        { "name": "Курьеры", "plan": 300, "fact": 440, "cpl": 76, "hidden": false },
        { "name": "Инвентаризация", "plan": 700, "fact": 1617, "cpl": 76, "hidden": false },
        { "name": "Гравис", "plan": 20, "fact": 61, "cpl": 99, "hidden": false }
      ],
      "urban":   { "leads": 273, "cpl": 182, "spend": 49757, "adapted": 25,  "conversion": 9.16 },
      "chlbkzn": { "leads": 441, "cpl": 111, "spend": 49069, "adapted": 212, "conversion": 48.07 },
      "msk":     { "leads": 180, "cpl": 132, "spend": 23724, "adapted": null, "conversion": null },
      "rostiks": { "leads": 137, "cpl": 177, "spend": 24232, "adapted": 0,   "conversion": 0 },
      "social": [
        {
          "name": "💙 ВКонтакте",
          "platform": "таргет / сообщество",
          "stats": [
            { "label": "Подписчики", "value": "1 344 → 1 354 (+10)" },
            { "label": "Лиды ВК / Юла", "value": "77 (ВК 62 + Юла 15)" },
            { "label": "Динамика лидов", "value": "40 → 77 (+37, +93%)" },
            { "label": "Расход", "value": "ВК 26 226 ₽ · Юла 4 050 ₽" },
            { "label": "Цена лида", "value": "ВК 423 ₽ · Юла 270 ₽" }
          ]
        },
        {
          "name": "✈ Telegram",
    ...
    },
    {
      ...
      "vk": 96,
      "yula": 19,
      "vkyulaNote": "ВК за 07.09–15.09 · Юла — чистая неделя",
      "extraKpi": {
        "label": "Проекты ДРС",
        "value": "847",
        "sub": "Урбан 104 · ЧЛБ+КЗН 422 · ВкусВилл 205 · Ростикс 116",
        "notes": [
          "↓ Урбан 273 → 104 лида: объявления сняты с поиска",
          "↓ CPL ЧЛБ+КЗН 111 → 94 ₽, лиды 441 → 422",
          "↓ CPL ВкусВилл 132 → 93 ₽ при росте 180 → 205 лидов",
          "Ростикс: расход 1 776 ₽ на 116 лидов — проверить данные"
        ]
      },
      "alerts": [
        {
          "type": "success",
          "title": "CPL Авито 91 → 62 ₽ (−32%) при росте лидов на 66%",
          "text": "3 499 → 5 811 лидов при расходе 317 617 → 362 641 ₽ (+14%). План ОПИ подняли с 2 230 до 3 520 — выполнен на 165%. Вторая неделя подряд, когда объём растёт быстрее бюджета."
        },
        {
          "type": "success",
          "title": "Инвентаризация: 2 993 лида при новом плане 2 000",
          "text": "План подняли с 700 до 2 000, выполнен на 150%. Проект дал 52% лидов ОПИ при 45% бюджета, по расходу лид стоит 55 ₽. ЛЕНТА МСК (587 → 924) и ЛЕНТА КРД (459 → 812) тоже выросли более чем в 1,5 раза."
        },
        {
          "type": "warning",
          "title": "ДРС: расход −53%, Урбан и Ростикс почти остановлены",
          "text": "Урбан Дикси 49 757 → 8 355 ₽, лиды 273 → 104: объявления сняли с поиска по просьбе Аллы — она сама обрабатывает отклики и сейчас отсутствует. Ростикс 24 232 → 1 776 ₽ при 116 лидах — лид по 15 ₽ выглядит как ошибка в расходе, нужно проверить таблицу. Лиды ДРС 1 031 → 847 (−18%)."
        },
        {
          "type": "warning",
          "title": "Конверсия ОПИ 2,7% → 0,9%, ДРС 24,7% → 27,0%",
          "text": "У Даниила 22 вышедших на 5 811 лидов. Главная причина падения — Инвентаризация: 8 вышедших из 2 993 лидов (0,3%) против 45 из 1 617 неделей раньше. Объём по проекту почти удвоился, а выходов стало в 5,6 раза меньше. У Дианы 197 вышедших: лидеры ЧЛБ Пятёрочка 26 из 35 (74,3%) и ЧЛБ Монетка 94 из 144 (65,3%). Колонку дозаполнили до конца: Пятёрочка КЗН 3 из 9 (33,3%), Лента КЗН 0 из 13. Ростикс — 0 вышедших при 116 лидах, вторая неделя подряд."
        },
        {
          "type": "warning",
          "title": "Ниже плана три проекта ДРС",
          "text": "ЧЛБ Монетка 144 из 160 (90%), Лента КЗН 13 из 15 (87%), Пятёрочка КЗН 9 из 10 (90%). Монетка неделей раньше была лидером по выходам — 150 вышедших."
        }
      ],
      "projects": [
        { "name": "МАГНИТ КРД", "plan": 150, "fact": 343, "cpl": 74, "hidden": false },
        { "name": "ЛЕНТА КРД", "plan": 450, "fact": 812, "cpl": 74, "hidden": false },
        { "name": "ЛЕНТА КЗН", "plan": 80, "fact": 116, "cpl": 70, "hidden": false },
        { "name": "ЛЕНТА МСК", "plan": 500, "fact": 924, "cpl": 70, "hidden": false },
        { "name": "ЛЕНТА ЧЛБ", "plan": 20, "fact": 24, "cpl": 75, "hidden": false },
        { "name": "Курьеры", "plan": 300, "fact": 575, "cpl": 74, "hidden": false },
        { "name": "Инвентаризация", "plan": 2000, "fact": 2993, "cpl": 75, "hidden": false },
        { "name": "Гравис", "plan": 20, "fact": 24, "cpl": 80, "hidden": false }
      ],
      "urban":   { "leads": 104, "cpl": 80,  "spend": 8355,  "adapted": 13,   "conversion": 12.5 },
      "chlbkzn": { "leads": 422, "cpl": 94,  "spend": 39667, "adapted": 185,  "conversion": 43.84 },
      "msk":     { "leads": 205, "cpl": 93,  "spend": 19121, "adapted": 2,    "conversion": 0.98 },
      "rostiks": { "leads": 116, "cpl": 15,  "spend": 1776,  "adapted": 0,    "conversion": 0 },
      "social": [
        {
          "name": "💙 ВКонтакте",
          "platform": "таргет / сообщество",
          "stats": [
            { "label": "Подписчики", "value": "1 354 → 1 385 (+31)" },
            { "label": "Лиды ВК / Юла", "value": "115 (ВК 96 + Юла 19)" },
            { "label": "Динамика лидов", "value": "77 → 115 (+38, +49%)" },
            { "label": "Расход", "value": "ВК 31 200 ₽ · Юла 3 363 ₽" },
            { "label": "Цена лида", "value": "ВК 325 ₽ · Юла 177 ₽" }
          ]
        },
        {
          "name": "✈ Telegram",
    ...
    },
    {
      ...
      "vk": 127,
      "yula": 16,
      "vkyulaNote": "ВК и Юла за 14.09–22.09",
      "extraKpi": {
        "label": "Проекты ДРС",
        "value": "1474",
        "sub": "Урбан 336 · ЧЛБ+КЗН 508 · ВкусВилл 428 · Ростикс 202",
        "notes": [
          "↑ CPL Урбан 80 → 128 ₽: объявления вернули в поиск, лиды 104 → 336",
          "↑ CPL ЧЛБ+КЗН 94 → 108 ₽ при росте лидов 422 → 508",
          "↓ CPL ВкусВилл 93 → 81 ₽ при росте 205 → 428 лидов, план поднят 150 → 300",
          "Ростикс: расход 1 776 → 28 282 ₽, лид 140 ₽ — прошлая неделя была ошибкой в расходе"
        ]
      },
      "alerts": [
        {
          "type": "success",
          "title": "CPL Авито 62 → 51 ₽ (−18%), план ОПИ 3 420 выполнен на 137%",
          "text": "4 675 лидов против 5 811 неделей раньше (−20%) при расходе 362 641 → 238 618 ₽ (−34%). Бюджет сократился сильнее объёма, поэтому лид подешевел. Все восемь проектов ОПИ выше плана. Просели ЛЕНТА КРД 812 → 372 (план снижен с 450 до 350), МАГНИТ КРД 343 → 201 и Курьеры 575 → 399. Единственный рост — ЛЕНТА МСК 924 → 1 020 (+10%)."
        },
        {
          "type": "success",
          "title": "ДРС: 847 → 1 474 лидов (+74%), план 894 выполнен на 165%",
          "text": "Урбан Дикси вернули в поиск: 104 → 336 лидов, расход 8 355 → 43 069 ₽. ВкусВилл 205 → 428 при плане, поднятом со 150 до 300. Ростикс 116 → 202, ЧЛБ Монетка 144 → 267 при плане 200. Расход ДРС 68 919 → 160 785 ₽ (+133%), лид подорожал 81 → 109 ₽. Ниже плана только Пятёрочка КЗН — 6 из 7."
        },
        {
          "type": "warning",
          "title": "Инвентаризация: расход −51% при лидах −16%, по расходу лид 32 ₽",
          "text": "2 522 лида за 80 384 ₽ против 2 993 за 163 709 ₽ неделей раньше. В колонке «Стоимость лида» стоит 72 ₽, по расходу выходит 32 ₽ — проверить, полностью ли внесён расход за неделю. Проект дал 54% лидов ОПИ при 34% бюджета."
        },
        {
          "type": "success",
          "title": "Конверсия ОПИ 0,7% → 2,9%, ДРС 27,0% → 28,3%",
          "text": "У Даниила 142 вышедших на 4 675 лидов против 22 неделей раньше — по уточнению Дани от 23.09: Инвентаризация 91, Курьеры 15, ЛЕНТА МСК 17, ЮФО 15 (разнесены на МАГНИТ КРД 5 и ЛЕНТА КРД 10 пропорционально лидам), ЛЕНТА ЧЛБ 3. Инвентаризация: 91 из 2 522 (3,6%) против 8 из 2 993; Курьеры 15 из 399 (3,8%). У Дианы 188 вышедших: лидеры Пятёрочка КЗН 4 из 6 (66,7%), ЧЛБ Пятёрочка 11 из 21 (52,4%) и ЧЛБ Табыш 36 из 73 (49,3%), Монетка 88 из 267 (33,0%). Слабые по выходам ВкусВилл 2 из 428 и Ростикс 3 из 202."
        },
        {
          "type": "success",
          "title": "ВК и Юла: 143 лида против 115 неделей раньше (+24%)",
          "text": "ВК дал 127 лидов, лид по 495 ₽ (расход 62 865 ₽): у Даниила 104 лида, у Дианы 23. Юла — 16 лидов по 370 ₽ (расход 5 920 ₽): 5 у Даниила, 11 у Дианы. Цена лида задана как средняя 23.09."
        },
        {
          "type": "success",
          "title": "Подписчики ВК 1 385 → 1 419",
          "text": "Прирост базы +34 за неделю. Это лучший результат за месяц: неделей раньше было +31, до этого +10 и +28."
        }
      ],
      "projects": [
        { "name": "МАГНИТ КРД", "plan": 150, "fact": 201, "cpl": 76, "hidden": false },
        { "name": "ЛЕНТА КРД", "plan": 350, "fact": 372, "cpl": 70, "hidden": false },
        { "name": "ЛЕНТА КЗН", "plan": 80, "fact": 102, "cpl": 69, "hidden": false },
        { "name": "ЛЕНТА МСК", "plan": 500, "fact": 1020, "cpl": 70, "hidden": false },
        { "name": "ЛЕНТА ЧЛБ", "plan": 20, "fact": 38, "cpl": 73, "hidden": false },
        { "name": "Курьеры", "plan": 300, "fact": 399, "cpl": 77, "hidden": false },
        { "name": "Инвентаризация", "plan": 2000, "fact": 2522, "cpl": 72, "hidden": false },
        { "name": "Гравис", "plan": 20, "fact": 21, "cpl": 83, "hidden": false }
      ],
      "urban":   { "leads": 336, "cpl": 128, "spend": 43069, "adapted": 12,   "conversion": 3.57 },
      "chlbkzn": { "leads": 508, "cpl": 108, "spend": 54728, "adapted": 171,  "conversion": 33.66 },
      "msk":     { "leads": 428, "cpl": 81,  "spend": 34706, "adapted": 2,    "conversion": 0.47 },
      "rostiks": { "leads": 202, "cpl": 140, "spend": 28282, "adapted": 3,    "conversion": 1.49 },
      "social": [
        {
          "name": "💙 ВКонтакте",
          "platform": "таргет / сообщество",
          "stats": [
            { "label": "Подписчики", "value": "1 385 → 1 419 (+34)" },
            { "label": "Лиды ВК / Юла", "value": "143 (ВК 127 + Юла 16)" },
            { "label": "Динамика лидов", "value": "115 → 143 (+28, +24%)" },
            { "label": "Расход", "value": "ВК 62 865 ₽ · Юла 5 920 ₽" },
            { "label": "Цена лида", "value": "ВК 495 ₽ · Юла 370 ₽" }
          ]
        },
        {
          "name": "✈ Telegram",
