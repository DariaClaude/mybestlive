  ...
  "weeks": [
    ...
    },
    {
      ...
      "alerts": [
        ...
        {
          "type": "success",
          "title": "ВК+Юла превысили прошлую неделю",
          "text": "Суммарно 24 → 29 лидов (+5, +21%). Юла кратно выросла: 2 → 10 (×5). ВК: 22 → 19 (−3, −14%). Реклама в TG приостановлена, идёт найм SMM-специалиста."
        }
      ],
      "projects": [
        {
