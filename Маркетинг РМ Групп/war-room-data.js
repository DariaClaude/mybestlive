  ...
  "weeks": [
    ...
    },
    {
      ...
      "alerts": [
        ...
        {
          "type": "warning",
          "title": "Конверсия ОПИ 2,7% → 0,9%, ДРС 24,7% → 29,6%",
          "text": "У Даниила 22 вышедших на 5 811 лидов. Главная причина падения — Инвентаризация: 8 вышедших из 2 993 лидов (0,3%) против 45 из 1 617 неделей раньше. Объём по проекту почти удвоился, а выходов стало в 5,6 раза меньше. У Дианы 197 вышедших: лидеры ЧЛБ Пятёрочка 26 из 35 (74,3%) и ЧЛБ Монетка 94 из 144 (65,3%). Ростикс — 0 вышедших при 116 лидах, вторая неделя подряд. Не заполнены Лента КЗН и Пятёрочка КЗН."
        },
        {
          "type": "warning",
      ...
      "chlbkzn": { "leads": 422, "cpl": 94,  "spend": 39667, "adapted": 182,  "conversion": 43.13 },
      ...
      "social": [
        {
          ...
          "stats": [
            ...
            { "label": "Лиды ВК / Юла", "value": "110 (ВК 91 + Юла 19)" },
            { "label": "Динамика лидов", "value": "77 → 110 (+33, +43%)" },
            { "label": "Расход", "value": "ВК 69 628 ₽ · Юла 1 468 ₽" },
            { "label": "Цена лида", "value": "ВК 765 ₽ · Юла 77 ₽" }
          ]
        },
        {
          "name": "✈ Telegram",
