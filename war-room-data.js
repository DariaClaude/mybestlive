  ...
  "weeks": [
    ...
    },
    {
      ...
      "extraKpi": {
        "label": "Проекты ДРС",
        "value": null,
        "sub": "ждём выгрузку Авито",
        "notes": []
      },
      "alerts": [
        {
          "type": "warning",
          "title": "Авито за неделю не внесён в дашборд",
          "text": "Доступ к таблице «Разбивка лидов» сейчас не работает — отключился коннектор Google Drive. Как только доступ вернётся, подтянутся лиды, расход, CPL и вышедшие по ОПИ и ДРС. Цифры по ВК и Юле в неделе уже актуальные."
        },
        {
          "type": "success",
