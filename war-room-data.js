  ...
  "weeks": [
    ...
    },
    {
      ...
      "alerts": [
        ...
        {
          "type": "warning",
          "title": "ДРС: нет данных по Ленте КЗН и Пятёрочке КЗН",
          "text": "В таблице обе строки пустые с пометкой «Кристина». Итог ЧЛБ+КЗН — 420 лидов и конверсия 48,1% — посчитан без них, поэтому сравнение с прошлой неделей (65,0%) неполное."
        },
        {
          "type": "warning",
        ...
        {
          "type": "warning",
          "title": "Адаптация из ОПИ: 17 человек с 1 995 лидов (0,85%)",
          "text": "Впервые в таблице появились адаптированные по каждому проекту ОПИ. Лучший результат — Лента ЧЛБ: 4 из 37 (10,8%). По Магниту КРД, Ленте КРД и Ленте МСК — ноль при 630 лидах суммарно."
        }
      ],
      "projects": [
        {
