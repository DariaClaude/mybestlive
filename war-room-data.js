  ...
  "weeks": [
    ...
    },
    {
      ...
      "alerts": [
        ...
        {
          "type": "warning",
          "title": "ВК остановился: 0 лидов с 03.08",
          "text": "Итого по каналу 26 → 27 лидов (по 04.08 включительно) — держимся за счёт Юлы: 2 → 10 (×5). ВК просел 24 → 17 за неделю и два рабочих дня подряд не даёт ни одного отклика при прежних 1–5 в день. Проверить кабинет: если открутка остановлена, за неделю потеряем ~15 лидов. Реклама в Telegram на паузе — продолжается найм SMM-специалиста."
        }
      ],
      "projects": [
        {
      ...
      "social": [
        {
          ...
          "stats": [
            ...
            {
              "label": "ВК с 03.08",
              "value": "0 лидов ↓ — проверить кабинет"
            }
          ]
        },
        {
