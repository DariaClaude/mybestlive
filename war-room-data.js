  ...
  "weeks": [
    ...
    },
    {
      ...
      "alerts": [
        ...
        {
          "type": "critical",
          "title": "Стоимость вышедшего: 5 343 ₽ у ОПИ против 488 ₽ у ДРС",
          "text": "У Даниила 58 вышедших на 3 293 лида Авито (1,8%) при расходе 309 879 ₽. У Дианы 252 вышедших на 914 лидов Авито (27,6%) при 123 010 ₽. CPL у обоих сопоставим, а стоимость результата отличается почти в 11 раз. Колонку «Вышедшие» по ОПИ дозаполнили после первой выгрузки — было 27, стало 58."
        },
        {
          "type": "warning",
    ...
    },
    {
      ...
      "alerts": [
        ...
        },
        {
          ...
          "text": "Против 27,6% неделей раньше. Лучшие: ЧЛБ Монетка 118 вышедших из 193 (61,1%), Лента ЧЛБ 30 из 52 (57,7%), ЧЛБ Пятёрочка 22 из 47 (46,8%). Стоимость вышедшего по ДРС — 531 ₽. Важно: по трём проектам колонка «Вышедшие» пустая — Ростикс (104 лида), Лента КЗН (21) и Пятёрочка КЗН (15). Это 140 лидов, или 17% объёма ДРС. По заполненным проектам конверсия 35,8%."
        },
        {
          "type": "warning",
          "title": "Вышедшие по ОПИ: 16 на 3 012 лидов (0,53%)",
          "text": "Неделей раньше было 58 на 3 293 (1,76%) — после того как колонку дозаполнили. Стоимость вышедшего выросла с 5 343 до 23 958 ₽. По Курьерам за неделю ячейка пустая при 219 лидах, поэтому цифра 16 может быть неполной — как это уже было с неделей 17–23."
        }
      ],
      "projects": [
    ...
    },
    {
      ...
      "extraKpi": {
        ...
        "notes": [
          ...
          "Вышедшие по ДРС за неделю не заполнены"
        ]
      },
      "alerts": [
        {
        ...
        {
          "type": "warning",
          "title": "ДРС: колонка «Вышедшие» не заполнена ни по одному проекту",
          "text": "1 031 лид за неделю, из них ни по одному не проставлены выходы — ни по Урбану, ни по ЧЛБ и КЗН, ни по ВкусВиллу и Ростиксу. Конверсию за неделю посчитать нельзя, сравнение с предыдущей неделей отключено. Неделей раньше по трём проектам из десяти было то же самое."
        },
        {
          "type": "warning",
          "title": "ВК: 60 лидов за 31.08–08.09 при расходе 44 853 ₽",
          "text": "Объём вырос более чем вдвое (26 → 60), цена лида снизилась с 906 до 748 ₽. Расход при этом почти удвоен: 23 562 → 44 853 ₽. У Дани 41 лид по 752 ₽, у Дианы 19 по 738 ₽ — цена по клиентам сравнялась. Юла за тот же период подорожала резче: 15 лидов при 15 817 ₽, то есть 1 054 ₽ за лид против 453 ₽ неделей раньше."
        }
      ],
      "projects": [
      ...
      "urban":   { "leads": 273, "cpl": 182, "spend": 49757, "adapted": null, "conversion": null },
      "chlbkzn": { "leads": 441, "cpl": 111, "spend": 49069, "adapted": null, "conversion": null },
      "msk":     { "leads": 180, "cpl": 132, "spend": 23724, "adapted": null, "conversion": null },
      "rostiks": { "leads": 137, "cpl": 177, "spend": 24232, "adapted": null, "conversion": null },
      "social": [
        {
          "name": "💙 ВКонтакте",
          "platform": "таргет / сообщество",
          "stats": [
            { "label": "Подписчики", "value": "—" },
            { "label": "Лиды ВК / Юла", "value": "75 (ВК 60 + Юла 15)" },
            { "label": "Динамика лидов", "value": "40 → 75 (+35, +88%)" },
            { "label": "Расход", "value": "ВК 44 853 ₽ · Юла 15 817 ₽" },
            { "label": "Цена лида", "value": "ВК 748 ₽ · Юла 1 054 ₽" }
          ]
        },
        {
          "name": "✈ Telegram",
